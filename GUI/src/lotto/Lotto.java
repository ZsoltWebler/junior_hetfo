...
public class Lotto extends JFrame {
	...
	private List<LottoInformation> readModel() {
		...
		try {
			Scanner scanner = new Scanner(
					new File("c:\\Users\\RN89\\junior_hetfo\\GUI\\src\\lotto\\otos.csv"));
	...
	public Lotto() {
		...
		table.setModel(new LottoInformationModel(informations));
		...
		btnNewButton_1 = new JButton("OpenFile");
		panel_2.add(btnNewButton_1);
		
		btnNewButton = new JButton("InsertRecord");
